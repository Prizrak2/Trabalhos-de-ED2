...
public class Buscar extends javax.swing.JFrame {
    ...
    private void jButton1_BUSCARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1_BUSCARActionPerformed
        ...
        try {
            // Cria um professores temporário para armazenar o resultado da busca
            Set<Professor> resultadoBusca = new TreeSet<>();

            // Percorre o professores principal
            Iterator<Professor> lista = mainUI.professores.iterator();
            while (lista.hasNext()) {
                Professor novoProf = lista.next();
                if (novoProf.getMatricula() == valor) {
                    resultadoBusca.add(novoProf);
                }
            }

            // Verifica se há resultados e os exibe
            if (!resultadoBusca.isEmpty()) {
                mainUI.listar_Dados(resultadoBusca.iterator());
            } else {
