...
import modelos.classes.Comparator_Nome;
...
public class MainUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("TABELA DOCENTE TREESET");
    ...
    public void listar_Dados(Iterator<Professor> lista) throws Exception {
    try {
    ...
    private void jButton1_ListarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1_ListarActionPerformed
        try {
            if(jComboBox1_Ordem.getSelectedItem().toString().compareTo("LISTAR-NOME") == 0){
                Set<Professor> professorNome = new TreeSet<>(new Comparator_Nome());
                Iterator<Professor> lista = professores.iterator();
                while(lista.hasNext()){
                    Professor novoProf = new Professor();
                    novoProf = lista.next();
                   professorNome.add(novoProf);    
                }
                listar_Dados(professorNome.iterator());
            }
            else{
                Set<Professor> professorMatricula = new TreeSet<>();
                Iterator<Professor> lista = professores.iterator();
                while(lista.hasNext()){
                    Professor novoProf = new Professor();
                    novoProf = lista.next();
                    professorMatricula.add(novoProf);
                }
                listar_Dados(professorMatricula.iterator());
            }
        } catch (Exception erro) {
        JOptionPane.showMessageDialog(this, erro.getMessage() + "Listar Dados\n");
        }
    ...
    private void jButton1_CARREGARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1_CARREGARActionPerformed
        ...
        try {
            ...
            if (returnVal == JFileChooser.APPROVE_OPTION) {
                ...
                for (Professor professor : arq.obterListaProfessores()) {
                ...
                listar_Dados(professores.iterator());
            }
        } catch (Exception erro) {
